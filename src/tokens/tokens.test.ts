...
describe("token layer — structural integrity", () => {
  it("bridges every semantic token (a missing bridge line generates no utility)", () => {
    const bridged = new Set(
      Object.values(bridge).flatMap((v) =>
        [...v.matchAll(/var\((--fui-[a-z0-9-]+)\)/g)].map((m) => m[1]),
      ),
    );
...
const PAIRS: ReadonlyArray<{ what: string; fg: string; bg: string; min: number }> = [
  ...
  {
    what: "Button primary hover label",
    fg: "--fui-on-action",
    bg: "--fui-action-primary-hover",
    min: 4.5,
  },
  {
    what: "Button primary active label",
    fg: "--fui-on-action",
    bg: "--fui-action-primary-active",
    min: 4.5,
  },
  { what: "Button danger label", fg: "--fui-on-action", bg: "--fui-action-danger", min: 4.5 },
  {
    what: "Button danger hover label",
    fg: "--fui-on-action",
    bg: "--fui-action-danger-hover",
    min: 4.5,
  },
  {
    what: "Button danger active label",
    fg: "--fui-on-action",
    bg: "--fui-action-danger-active",
    min: 4.5,
  },
  {
    what: "Button outline label",
    fg: "--fui-action-secondary-text",
    bg: "--fui-surface-raised",
    min: 4.5,
  },
  {
    what: "Button outline hover label",
    fg: "--fui-action-secondary-text-hover",
    bg: "--fui-surface-raised",
    min: 4.5,
  },
  {
    what: "Button outline active label",
    fg: "--fui-action-secondary-text-active",
    bg: "--fui-surface-raised",
    min: 4.5,
  },
  {
    what: "Button outline border",
    fg: "--fui-action-secondary-border",
    bg: "--fui-surface-raised",
    min: 3,
  },
  {
    what: "Button ghost label",
    fg: "--fui-action-secondary-text",
    bg: "--fui-surface-page",
    min: 4.5,
  },
  ...
  {
    what: "Button danger outline label",
    fg: "--fui-action-danger-outline",
    bg: "--fui-surface-raised",
    min: 4.5,
  },
  ...
  {
    what: "Input placeholder ink",
    fg: "--fui-text-color-placeholder",
    bg: "--fui-surface-raised",
    min: 4.5,
  },
...
describe.each(["light", "dark"] as const)(
  "contrast — %s mode, base (Figma-faithful) layer",
  (mode) => {
...
describe.each(["light", "dark"] as const)(
  "contrast — %s mode, with a11y.css (must reach AA)",
  (mode) => {
    it.each(PAIRS)("$what", ({ what, fg, bg, min }) => {
