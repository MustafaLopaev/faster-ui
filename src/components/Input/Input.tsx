...
export const Input = forwardRef<HTMLInputElement, InputProps>(function Input(props, ref) {
  ...
  const state: State = disabled
    ...
    : error
      ? InputState.error
      : InputState.default;
  const adornmentColor = disabled ? INPUT_ADORNMENT_COLOR.disabled : INPUT_ADORNMENT_COLOR.enabled;
    ...
    <div className={cn(INPUT_ROOT, className)}>
      ...
      >
        ...
        {prefix != null && (
          <span
            aria-hidden="true"
            className={cn(INPUT_AFFIX, INPUT_TEXT_RAMP[size], adornmentColor)}
          >
            {prefix}
          </span>
        )}
